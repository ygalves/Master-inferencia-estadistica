...
<h3><strong>MAESTRIÍA EN INTELIGENCIA ARTIFICIAL Y CIENCIA DE DATOS</strong></h3>
...
*   Para este análisis vamos a valcular la esperanza para despejar en la fórmula de la densidad

 
```{r}
###############################################################################
# Evaluar las propiedades de los estimadores de los tiempos de atencion en call center
#
#
# Se simula el comportamiento de estos estimadores para diferentes escenarios
# variando el valor real de θ y el tamaño de muestra n.
